<?php
    ...
    if(isset($_POST['add_fleet_category']))
    {
        ...
        {                         
            ...
            if($postStmt)
            {
                $success = "Fleet Category Added" && header("refresh:1; url=subordinate_add_fleet_category.php");
            }
            else 
            {
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="subordinate_add_fleet_category.php">Fleet</a></li>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <textarea type="text" rows="5" name="category_desc"  class="form-control" ></textarea>
                            </div>
                        </div>
                    </div>
                    <!-- /.card-body -->
