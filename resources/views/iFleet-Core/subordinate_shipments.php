        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
                <a class="btn btn-outline-success" href="subordinate_add_shipment.php">
                    <span>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a class="badge badge-warning" href="subordinate_update_shipment.php?s_id=<?php echo $shipment->s_id;?>">
