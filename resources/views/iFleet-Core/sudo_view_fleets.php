        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
                <a class="btn btn-outline-success" href="sudo_add_fleet.php?fleet_category_id=<?php echo $category->category_id;?>&fleet_category_name=<?php echo $category->category_name;?>">
                    <span>
