        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
                <a class="btn btn-outline-success" href="subordinate_add_vehicle.php">
                    <span>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td>
                                <a class="text_success" href="subordinate_view_vehicle.php?reg=<?php echo $vehicle->v_reg_no;?>">
                            ...
                            <td>
                                <a class="badge badge-warning" href="subordinate_update_vehicle.php?v_id=<?php echo $vehicle->v_id;?>">
