<?php
    ...
    if(isset($_POST['add_fleet']))
    {
            ...
            {                         
                ...
                if($postStmt)
                {
                    $success = "Fleet Added" && header("refresh:1; url=subordinate_add_fleet.php?fleet_category_id=$fleet_category_id&fleet_category_name=$fleet_category_name");
                }
                else 
                {
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="subordinate_get_fleet_categories.php">Fleet</a></li>
              <li class="breadcrumb-item"><a href="subordinate_get_fleet_categories.php"><?php echo $category->category_name;?></a></li>
